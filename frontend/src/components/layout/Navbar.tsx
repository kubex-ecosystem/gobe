...
const NAV_ITEMS = [
  { key: "nav.home", label: "home", to: "/app/" },
  { key: "nav.manifesto", label: "manifesto", to: "/app/manifesto" },
  { key: "nav.access", label: "access", to: "/app/access" },
];
  ...
  return (
    <header className="sticky top-0 z-20 border-b border-slate-200/60 bg-white/80 backdrop-blur dark:border-slate-800/70 dark:bg-slate-900/80">
      <div className="mx-auto flex h-16 max-w-6xl items-center justify-between px-4 sm:px-6">
        <Link to="/app/" className="group flex items-center gap-3 text-slate-900 dark:text-slate-100">
