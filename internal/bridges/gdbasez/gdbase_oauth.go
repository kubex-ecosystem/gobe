...
// // func NewOAuthClientService(ctx context.Context, dbService svc.DBService) OAuthClientService {
...
// // Note: This function still accepts *gorm.DB but this is the ONLY place where it's needed
// // All other code uses only interfaces
// // func NewAuthCodeService(ctx context.Context, dbService svc.DBService) AuthCodeService {
